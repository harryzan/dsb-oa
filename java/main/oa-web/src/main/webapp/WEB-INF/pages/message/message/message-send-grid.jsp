...
//        deleteurl = false;
//        modifyurl = false;
//        if(result.s07_message_C){
//            addurl = false;
//        }
//        if(result.s07_message_D){
//            deleteurl = false;
//        }
//        if(result.s07_message_U){
//            modifyurl = false;
//        }
        //grid 参数配置
        var params = {
...
//                {name:"description",header:"内容",width:"40%"}
        ...
        function goResult(id, name){
            ...
            var messageId = record.data["id"];
            doRequest("${ctx}/s/s07/message!changeStatus?id=" + messageId, "POST", null);
        }
