      ...
      <%--<tr>--%>
        ...
        <%--<td background="${themesPath}/oldimages/bgz.gif"><table width="100%" height="10"  border="0" align="right" cellpadding="0" cellspacing="2">--%>
            <%--<tr>--%>
              ...
              <%--<td height="23" valign="bottom" class="textone" align="center"><strong>业务文档类型信息查看</strong></td>--%>
              <%--<td width="20">&nbsp;</td>--%>
            <%--</tr>--%>
        <%--</table></td>--%>
                  ...
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr class="textone1">
                          <td colspan="2" align="center" class="text_title"><div align="center">业务文档类型信息查看</div></td>
                          </tr>
                        <tr class="textone1">
                        ...
                        <tr class="textone12">
                          <td class="textone1"><div align="right">用途：</div></td>
                          <td class="textone1">&nbsp;${purpose}</td>
                          </tr>
                      </table>
                        </td>
