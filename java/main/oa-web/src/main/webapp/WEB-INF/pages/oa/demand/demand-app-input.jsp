                    ...
                    <tr>
                      ...
                      <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <c:if test="${type.name != '会议'}">
                              ...
                              <tr class="textone1">
                                  <td><div align="right" class="textone1">描述：</div></td>
                          ...
                          <c:if test="${type.name == '会议'}">
                              ...
                              <tr class="textone12">
                                  ...
                                  <td width="70%" class="textone1">&nbsp;${moderater}</td>
                              </tr>
                              <tr class="textone1">
                          ...
                          <tr class="textone12">
                              ...
                              <td class="textone1">&nbsp;
                            <textarea name="memo" cols="60%" rows="10" class="input_long">${memo}</textarea></td>
                          </tr>
                          <tr class="textone1">
                          ...
                          <%--<tr class="textone1">--%>
                              <%--<td><div align="right">是否完成安排：</div></td>--%>
                              <%--<td height="60">&nbsp;--%>
