...
//             log.error("执行HTTP Get请求" + url + "时，发生异常！", e);
     ...
     public void updateTray() {
         String returnvalue = doGet("http://localhost:8080/oa/common/ajax-util!messagecount?username=" + username + "&password=" + password, null, "GBK", true);
         ...
         menuMessage.setLabel("Message(1)");
