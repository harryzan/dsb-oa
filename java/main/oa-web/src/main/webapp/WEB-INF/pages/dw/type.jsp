...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="250" valign="top"><table width="250" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="38" background="${themesPath}/dwimages/title7_1.jpg"><table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td class="title_text1">${tname}</td>
          </tr>
        </table></td>
      </tr>
      <tr>
          <td valign="top"  background="${themesPath}/dwimages/title8.jpg"><table width="250" border="0" cellpadding="0" cellspacing="0">
              <s:iterator value="subDwTypes">
                  <tr>
                      <td width="32" height="25" align="center"><img src="${themesPath}/dwimages/d5.jpg" width="7" height="7" /></td>
                      <td width="202"><a href="type?tid=${tid}&typeid=${id}">${name}</a></td>
                  </tr>
                  <tr>
    ...
    <td valign="top"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="33" background="${themesPath}/dwimages/line.jpg"><table width="690" border="0" cellpadding="0" cellspacing="0">
          <tr>
      ...
      <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="table_line">
      <tr>
          <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <s:iterator value="dws">
                  <tr>
