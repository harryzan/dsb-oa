...
public class DocDocumentGridAction extends PageActionSupport<DocDocument> {
    ...
    public String main() throws Exception {
        DocCategory doccategory = docCategoryDao.findUnique("from DocCategory category where category.code = 'video' and category.issystem is true  and category.parent is null order by category.orderno");
        if (doccategory != null) {
