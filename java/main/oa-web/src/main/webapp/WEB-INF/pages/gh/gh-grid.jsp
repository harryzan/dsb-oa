...
//        var result = doPrivilege(privilegecode);
        var addurl = "gh!input?typeid=${typeid}";
        var modifyurl = "gh!input?typeid=${typeid}";
        var deleteurl = "gh!delete";
...
//        }
        ...
        var params = {
            ...
            url:"gh-grid!griddata?typeid=${typeid}",
            addUrl:addurl,
            modifyUrl:modifyurl,
            deleteUrl:deleteurl,
...
//                ["内容","","String","description"],
        ...
        function goResult(id, name){
            ...
            var ghId = record.data["id"];
            doRequest("${ctx}/s/s07/gh!changeStatus?id=" + ghId, "POST", null);
        }
