      ...
      <tr>
        <td height="50" colspan="4" class="table_gw_td" ><table width="98%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="82%"><input name="workno" id="workno" type="text" class="input_one" value="${workno}"/></td>
          </tr>
        </table></td>
        <td width="113" class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="82%"><input name="fast" id="fast" type="text" class="input_one2" value="${fast}"/></td>
            </tr>
          </table></td>
        <td width="117" class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="82%"><input name="security" id="security" type="text" class="input_one2" value="${security}"/></td>
            </tr>
          </table></td>
      </tr>
      <tr>
        ...
        <td width="137" nowrap="nowrap"  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="82%" nowrap="nowrap">
                  ...
                  <input name="checkusername" id="checkusername" type="text" class="input_one" readonly />
        ...
        <td colspan="2"  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="82%" nowrap="nowrap">
                  ...
                  <input name="modifyusername" id="modifyusername" type="text" class="input_one" readonly />
      ...
      <tr>
        <td height="50" colspan="2"  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="59%" nowrap="nowrap">
                  ...
                  <input name="typeusername" id="typeusername" type="text" class="input_one" readonly />
        ...
        <td  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="82%" nowrap="nowrap">
                  ...
                  <input name="collateusername" id="collateusername" type="text" class="input_one" readonly />
        ...
        <td  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="82%" nowrap="nowrap">
                  ...
                  <input name="printusername" id="printusername" type="text" class="input_one" readonly />
        ...
        <td colspan="2"  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="82%"><input name="num" id="num" type="text" class="input_one2" value="${num}"/></td>
            </tr>
          </table></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="50" colspan="6"  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="90%"><input name="keyword" id="keyword" type="text" class="input_chang" value="${keyword}"/></td>
            </tr>
          </table></td>
        </tr>
      <tr>
        <td height="50" colspan="6"  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="90%"><input name="title" id="title" type="text" class="input_chang" value="${title}"/></td>
            </tr>
          </table></td>
        </tr>
      <td height="50" colspan="6"  class="table_gw_td"><table width="98%" border="0" cellpadding="0" cellspacing="0">
