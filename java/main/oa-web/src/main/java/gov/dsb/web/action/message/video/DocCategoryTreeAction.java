package gov.dsb.web.action.message.video;
...
public class DocCategoryTreeAction extends TreeActionSupport {
    ...
    public String treedata() throws Exception {
        ...
        if (id.equals("root")) {
            Collection<DocCategory> mp = service.findByQuery("from DocCategory category where category.code = 'guizhangzhidu' and category.issystem is true  and category.parent is null order by category.orderno");
