                      ...
                      <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="1">
                          <c:if test="${type.name != '会议'}">
                              ...
                              <tr class="textone1">
                                ...
                                <td width="85%" class="textone1">&nbsp;${name} </td>
                              </tr>
                              <tr class="textone12">
                                  <td width="30%" class="textone1"><div align="right">申请人：</div></td>
                                  <td width="85%" class="textone1">&nbsp;${user.displayname}</td>
                              </tr>
                              <tr class="textone1">
                                  <td width="30%" class="textone1"><div align="right">申请科室：</div></td>
                                  <td width="85%" class="textone1">&nbsp;${user.sysdept.name}</td>
                              </tr>
                              <tr class="textone12">
                                  <td width="30%" class="textone1"><div align="right">需求日期：</div></td>
                                  <td width="85%" class="textone1">&nbsp;${demanddate}</td>
                              </tr>
                              <tr class="textone1">
                          ...
                          <tr class="textone12">
                              <td width="30%" class="textone1"><div align="right">状态：</div></td>
                              <td width="85%" colspan="3" class="textone1">&nbsp;
