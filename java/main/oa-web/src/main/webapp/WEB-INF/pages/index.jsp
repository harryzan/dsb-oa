    ...
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td><img src="${themesPath}/login/title.png" width="500" height="50" /></td>
                </tr>
            </table></td>
        </tr>
        <tr>
            <td height="509" background="${themesPath}/login/login_2.jpg" style="background-repeat:no-repeat; background-position:center">
                <table width="100%" border="0">
                    <tr>
                        <td width="72%" height="250" valign="top">&nbsp;</td>
                        <td width="28%">&nbsp;</td>
                    </tr>
                    <tr>
