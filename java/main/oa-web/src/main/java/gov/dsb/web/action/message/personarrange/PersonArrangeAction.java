package gov.dsb.web.action.message.personarrange;
...
public class PersonArrangeAction extends CRUDActionSupport<PersonArrange> {

    @Autowired
    private PersonArrangeDao service;
    ...
    private List<PersonArrange> arranges;
    ...
    public List<PersonArrange> getArranges() {
        return arranges;
    }

    public void setArranges(List<PersonArrange> arranges) {
...
//        }
        ...
        arranges = service.findByQuery("from PersonArrange where week=? and year=? order by starttime", week.toString(), year.toString());
