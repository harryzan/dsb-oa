...
//        var result = doPrivilege(privilegecode);
        function initTree() {
            ...
            //定义树的根节点
            var root = new Ext.tree.AsyncTreeNode({id:'root',text:'用户信息',icon:iconPath + 'departments.gif'});
...
//                }
        ...
        function onClick(node, e)
        {
            ...
            if (id == "root") {
                ...
                TreeAction("user-attendance!record?deptid=" + getIdElement(id));
            }
            else if (id.indexOf("sys-user") >= 0) {
//                if(!result.s02_user_R){
                TreeAction("user-attendance!record?userid=" + getIdElement(id));
//                }
            }
        }
