...
@Entity
@Table(name = "DWTYPE")
public class DwType extends IdEntity implements Treeable {
    ...
    private DwType parent;

    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "PARENTID", referencedColumnName = "ID")
    public DwType getParent() {
        return parent;
    }

    public void setParent(DwType parent) {
        this.parent = parent;
    }

    private Collection<DwType> children;

    @OneToMany(mappedBy = "parent")
    @OrderBy("tag")
    public Collection<DwType> getChildren() {
        return children;
    }

    public void setChildren(Collection<DwType> children) {
        this.children = children;
    }

    private Collection<Dw> dws;

    @OneToMany(mappedBy = "dwType")
    public Collection<Dw> getDws() {
        return dws;
    }

    public void setDws(Collection<Dw> dws) {
        this.dws = dws;
    }
}
