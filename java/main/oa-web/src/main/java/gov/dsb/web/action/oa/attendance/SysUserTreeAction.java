...
public class SysUserTreeAction extends TreeActionSupport {
    ...
    public String treedata() throws Exception {
        ...
        if (id.equals("root")) {
            Collection<SysUser> sysusers = sysUserEntityService.findByQuery("from SysUser s order by sysdept.orderno, id");
