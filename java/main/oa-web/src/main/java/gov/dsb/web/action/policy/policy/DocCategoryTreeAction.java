...
public class DocCategoryTreeAction extends TreeActionSupport {
    ...
    public String treedata() throws Exception {
        ...
        if (id.equals("root")) {
            Collection<DocCategory> mp = service.findByQuery("from DocCategory category where category.name = 'guizhangzhidu' and category.parent is null order by category.orderno", false);
