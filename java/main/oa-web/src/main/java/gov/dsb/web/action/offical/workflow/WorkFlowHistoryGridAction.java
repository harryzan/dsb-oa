...
public class WorkFlowHistoryGridAction extends PageActionSupport<WorkFlow> {
...
//    public void setWorkFlowstatus(Boolean bulletinstatus) {
...
//        else
        ...
        List<WorkFlow> list = page.getResult();
