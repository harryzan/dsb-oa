      ...
      <%--<tr>--%>
        ...
        <%--<td background="${themesPath}/oldimages/bgz.gif"><table width="100%" height="10"  border="0" align="right" cellpadding="0" cellspacing="2">--%>
            <%--<tr>--%>
              ...
              <%--<td height="23" valign="bottom" class="textone" align="center"><strong>维护信息</strong></td>--%>
              <%--<td width="20">&nbsp;</td>--%>
            <%--</tr>--%>
        <%--</table></td>--%>
        ...
        <table width="90%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="textone1">
                      <td align="right"  class="text_title">名称：</td>
                      <td  class="text_title">&nbsp;${name}</td>
                    </tr>
                    <tr class="textone12">
                      <td height="90"  class="text_title"><div align="right">描述：</div></td>
                      <td  class="text_title"><div align="left">&nbsp;${definition}</div></td>
                    </tr>
                    <%--<tr class="textone1">--%>
